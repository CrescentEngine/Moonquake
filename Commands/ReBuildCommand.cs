...
{
    public class ReBuildSettings : CommandSettings
    {
    ...
    public class ReBuildCommand : Command<ReBuildSettings>
    {
        public override int Execute(CommandContext Context, ReBuildSettings Settings, CancellationToken CancellationToken)
        {
